...
public class TC_FB_Settings_4 {
    WebDriver driver;

    @BeforeMethod
    public void TC_FB_Settings_4(){
    ...
    public void TC_FB_Settings_4Test(String user, String Pass) throws InterruptedException {
