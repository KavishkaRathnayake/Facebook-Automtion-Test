...
public class TC_FB_Settings_7 {
    WebDriver driver;

    @BeforeMethod
    public void TC_FB_Settings_7() {
    ...
    public void TC_FB_Settings_7Test(String user, String Pass) throws InterruptedException {
        ...
        WebElement compactMode = driver.findElement(By.xpath("//input[@value='on']"));
        compactMode.click();
