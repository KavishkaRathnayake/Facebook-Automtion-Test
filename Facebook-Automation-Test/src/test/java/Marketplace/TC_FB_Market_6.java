...
//        Price.sendKeys("1000");
        ...
        WebElement Error1 = driver.findElement(By.xpath("//span[normalize-space()='Please enter a valid title.']"));
        String ErrorMsg = Error1.getText();
        System.out.println("Error Message: " + ErrorMsg);

        WebElement Error2 = driver.findElement(By.xpath("//span[normalize-space()='Enter a price for your item.']"));
